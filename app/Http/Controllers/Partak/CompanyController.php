...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('partak.dashboard.companies.index')->with([
    ...
    public function create()
    {
        ...
        return view('partak.dashboard.companies.create', ['companies_group' => $companies_group]);
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('partak.companies.index')->with('success', 'اطلاعات شرکت با موفقیت ساخته شد!');
        } catch (Exception $ex) {
    ...
    public function edit($id)
    {
        ...
        return view('partak.dashboard.companies.edit', [
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('partak.companies.index')->with('success', 'اطلاعات شرکت با موفقیت آپدیت شد !');
        } catch (Exception $ex) {
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('partak.companies.index')->with('success', 'شرکت با موفقیت حذف شد !');
    }
}
