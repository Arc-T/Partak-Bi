...
class CompanyGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('partak.dashboard.companies-group.index' ,[
    ...
    {
        return view('partak.dashboard.companies-group.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('partak.companies-group.index')->with('success', 'گروه شرکت جدید با موفقیت ساخته شد !');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('partak.dashboard.companies-group.edit',[
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('partak.companies-group.index')->with('success', 'گروه شرکت با موفقیت آپدیت شد !');
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('partak.companies-group.index')->with('success', 'گروه شرکت با موفقیت حذف شد !');
        } catch (\Exception $e) {
