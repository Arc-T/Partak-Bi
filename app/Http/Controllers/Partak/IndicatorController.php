...
class IndicatorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('partak.dashboard.indicators.index')->with([
    ...
    public function create()
    {
        ...
        return view('partak.dashboard.indicators.create', ['indicator_groups' => $indicators_group_table]);
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('partak.indicators.index')->with('success', 'شاخص با موفقیت ثبت گردید !');
        } catch (Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('partak.dashboard.indicators.edit', ['indicator' => $indicator_query, 'indicator_groups' => $indicator_group_table]);
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('partak.indicators.index')->with('success', 'شاخص با موفقیت آپدیت شد !');
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('partak.indicators.index')->with('success', 'شاخض با موفقیت حذف شد !');

        } catch (\Exception $e) {

            return redirect()->route('partak.indicators.index')->with('error', 'مشکلی در حذف شاخض رخ داده است !');
        }
    }
}
