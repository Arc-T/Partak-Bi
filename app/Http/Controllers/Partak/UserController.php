...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('partak.dashboard.users.index', [
            'users'     => $users_table
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('partak.dashboard.users.create', [
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('partak.users.index')->with('success', 'اطلاعات کاربر با موفقیت ثبت شد !');
        } catch (Exception $e) {
            dd($e);
    ...
    public function edit($id)
    {
        ...
        return view('partak.dashboard.users.edit',[
            'user'      => $user_info
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('partak.users.index')->with('success', 'عملیات تغییر اطلاعات با موفقیت انجام شد !');
        } catch (\Exception $e) {
