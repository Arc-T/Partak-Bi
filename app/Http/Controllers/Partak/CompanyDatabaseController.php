...
class CompanyDatabaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('partak.dashboard.companies-database.index', [
    ...
    public function create()
    {
        ...
        return view('partak.dashboard.companies-database.create', [
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('test_connection')) {
            ...
            try {
                ...
                return redirect()->route('partak.companies-database.index')->with('success', 'اطلاعات پایگاه داده با موفقیت ثبت شد !');
            } catch (Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view(
            'partak.dashboard.companies-database.edit',
            [
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('test_connection')) {
            ...
            try {
                ...
                return redirect()->route('partak.companies-database.index')->with('success', 'عملیات تغییر اطلاعات با موفقیت انجام شد !');
            } catch (Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('partak.companies-database.index')->with('success', 'پایگاه داده با موفقیت حذف شد !');
        } catch (Exception $e) {
            return redirect()->route('partak.database.list')->with('error', 'مشکلی در حذف پایگاه داده رخ داده است !');
        }
    }
}
